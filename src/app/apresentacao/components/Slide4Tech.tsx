...
const SiNextdotjs = (props: React.SVGProps<SVGSVGElement>) => (
...
const SiTailwindcss = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" {...props}><path d="M12.001,4.8c-3.2,0-5.2,1.6-6,4.8c1.2-1.6,2.6-2.2,4.2-1.8c0.913,0.228,1.565,0.89,2.288,1.624 C13.666,10.618,15.027,12,18.001,12c3.2,0,5.2-1.6,6-4.8c-1.2,1.6-2.6,2.2-4.2,1.8c-0.913-0.228-1.565-0.89-2.288-1.624 C16.337,6.182,14.976,4.8,12.001,4.8z M6.001,12c-3.2,0-5.2,1.6-6,4.8c1.2-1.6,2.6-2.2,4.2-1.8c0.913,0.228,1.565,0.89,2.288,1.624 c1.177,1.194,2.538,2.576,5.512,2.576c3.2,0,5.2-1.6,6-4.8c-1.2,1.6-2.6,2.2-4.2,1.8c-0.913-0.228-1.565-0.89-2.288-1.624 C10.337,13.382,8.976,12,6.001,12z"/></svg>
);

const SiTelegram = (props: React.SVGProps<SVGSVGElement>) => (
    ...
    <div className="flex flex-col justify-center h-full px-12 md:px-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-6 max-w-6xl mx-auto w-full h-[550px]">
        ...
        <div className="md:row-span-2 bg-zinc-900 border border-white/10 rounded-3xl p-10 relative overflow-hidden group hover:border-white/30 transition-colors flex flex-col justify-between animate-in fade-in zoom-in-95 duration-500 delay-300 fill-mode-both">
          <div className="absolute -bottom-10 -right-10 opacity-5 group-hover:scale-110 group-hover:-rotate-6 transition-transform duration-500">
             <SiNextdotjs className="w-[350px] h-[350px] text-white" />
          </div>
