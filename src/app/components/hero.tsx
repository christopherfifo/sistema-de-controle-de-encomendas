        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="max-w-2xl z-10">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white tracking-tight leading-[1.1] mb-6">
              ...
              <span className="text-emerald-400">totalmente digital.</span>
            </h1>
              ...
              <div className="flex-1 p-6 flex flex-col gap-4 overflow-hidden relative">
                ...
                <div className="flex flex-col gap-3">
                  {packages.map((item, i) => (
                    <div
                      key={i}
                      className="flex items-center justify-between p-4 rounded-xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.04] transition-colors group"
                    >
                      <div className="flex items-center gap-4">
                        <div
                      ...
                      >
                        ...
                        <span
                          className={`text-[10px] font-bold tracking-wider uppercase ${item.isDelivered ? "text-emerald-400" : "text-yellow-400"}`}
                        >
                          {item.status}
                        </span>
                      </div>
