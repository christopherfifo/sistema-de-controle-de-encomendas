...
import { CadastroSindicoContent } from "../components/cadastroSindicoContent";
...
export default async function CadastroSindicoPage({
  params,
  searchParams,
}: PageProps) {
  ...
  const sindicos = await db.usuario.findMany({
    where: {
