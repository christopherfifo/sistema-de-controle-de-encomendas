        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="max-w-2xl z-10">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-foreground tracking-tight leading-[1.1] mb-6">
              ...
              <span className="text-emerald-500">totalmente digital.</span>
            </h1>

            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              O CondoDrop moderniza o recebimento de pacotes. Notificações
              automáticas, rastreamento em tempo real e fim do extravio de
              encomendas.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <RoleModal>
                <Button
                  size="lg"
                  className="w-full sm:w-auto h-12 bg-emerald-500 text-emerald-950 hover:bg-emerald-600 rounded-md px-8 text-base font-semibold transition-all shadow-[0_0_20px_rgba(16,185,129,0.15)]"
                >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="w-full sm:w-auto h-12 border-input bg-background text-foreground hover:bg-accent rounded-md px-8 text-base"
              >
            ...
            <div className="mt-10 flex items-center gap-6 text-sm text-muted-foreground font-medium">
              <div className="flex items-center gap-2">
                <ShieldCheck className="h-5 w-5 text-emerald-500" /> Retirada
                Segura
              </div>
              <div className="flex items-center gap-2">
                <Clock className="h-5 w-5 text-emerald-500" /> Notificações na
                Hora
              </div>
            </div>
          </div>
          ...
          <div className="relative w-full h-[400px] lg:h-[550px] bg-muted border rounded-2xl p-4 shadow-2xl z-10 hidden md:block">
            ...
            <div className="relative w-full h-full rounded-xl overflow-hidden bg-background border flex flex-col shadow-inner">
              ...
              <div className="h-14 border-b bg-muted/30 flex items-center px-6 justify-between">
                ...
                <div className="flex items-center gap-2 px-3 py-2 bg-muted rounded-md w-1/3 border">
              ...
              <div className="flex-1 p-6 flex flex-col gap-4 overflow-hidden relative">
                ...
                <div className="flex items-end justify-between mb-4">
                  <div>
                    ...
                    <div className="h-3 w-64 bg-muted-foreground/10 rounded"></div>
                  </div>
                ...
                <div className="flex flex-col gap-3">
                  {packages.map((item, i) => (
                    <div
                      key={i}
                      className="flex items-center justify-between p-4 rounded-xl border bg-muted/20 hover:bg-muted/40 transition-colors group"
                    >
                      <div className="flex items-center gap-4">
                        <div
                          className={`p-2.5 rounded-lg ${item.isDelivered ? "bg-emerald-500/10" : "bg-yellow-500/10"} group-hover:scale-110 transition-transform`}
                        >
                          <Package
                            className={`w-5 h-5 ${item.isDelivered ? "text-emerald-500" : "text-yellow-500"}`}
                          />
                        </div>
                        <div>
                      ...
                      <div
                        className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full border ${item.isDelivered ? "border-emerald-500/20 bg-emerald-500/10" : "border-yellow-500/20 bg-yellow-500/10"}`}
                      >
                        {item.isDelivered ? (
                          <CheckCircle2
                        ...
                        <span
                          className={`text-[10px] font-bold tracking-wider uppercase ${item.isDelivered ? "text-emerald-500" : "text-yellow-500"}`}
                        >
                          {item.status}
                        </span>
                      </div>
